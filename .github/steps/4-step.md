...
1. Clique em **Closed** para exibir o alerta que acabamos de resolver.
   ...
   <img width="350" alt="botão de alertas fechados" src="https://github.com/LucasQuirino007/skills-introduction-to-codeql/blob/main/.github/images/closed-alerts-button.png?raw=true" />

1. Abra o alerta e note que a trilha de auditoria agora inclui como o alerta foi corrigido.

   <img width="350" alt="trilha de auditoria do alerta corrigido" src="https://github.com/LucasQuirino007/skills-introduction-to-codeql/blob/main/.github/images/audit-trail-fixed-alert.png?raw=true" />
